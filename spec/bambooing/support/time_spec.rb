RSpec.describe Bambooing::Support::Time do
  describe '.rand_work' do
    ...
    it 'returns an array of hashes' do
      result = described_class.rand_work(hours: 8, start_hour: 8, breaks: 1)
    ...
    context 'when no break is set' do
      it 'returns one period' do
        result = described_class.rand_work(hours: hours, start_hour: start_hour, breaks: 0)
    ...
    context 'when 2 breaks are set' do
      it 'returns three periods' do
        result = described_class.rand_work(hours: hours, start_hour: start_hour, breaks: 2)
